...
- Сила гравитации раскладывается просто
- Нормальная реакция направлена вдоль одной оси
...
1. **Сила тяжести:**
   - На наклонной: $\vec{F}_g = (mg\sin\theta, 0)$
   - На горизонтали: $\vec{F}_g = (0, 0)$ (компенсируется реакцией опоры)
