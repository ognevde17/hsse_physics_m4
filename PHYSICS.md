...
- Движение происходит только вдоль оси X
- Y-координата (высота) не меняется, следовательно $v_y = 0$ и $a_y = 0$
- Сила реакции опоры полностью компенсирует силу тяжести
- Шар движется исключительно под действием силы трения, направленной вдоль оси X
